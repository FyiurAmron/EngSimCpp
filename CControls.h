...
enum	ControlAction{ControlNothing,ControlChangedValue};
enum FocusSelect
{
	NoSelect,
	SelectAll
...
enum ControlType {ControlTypeUndefined, ControlTypeInputNum, ControlTypeInputText, ControlTypeButton, ControlTypeSlider};

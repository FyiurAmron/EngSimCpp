...
enum SimCalcReason {SimCalcReasonOrdered, SimCalcReasonRegular};
enum SimStart {SimStartWithInit,SimStartReset};
...
public:
	...
	CSimulation(){t_step=1e-6;t_start=0;t_end=10;t=0;calcInterval=-1;terminateThread=0;nTicks=0;nTicksOrdered=0;t_prev_regular=0;nDefaultSignalSize=SIGNAL_DEF_LENGTH;safeToTerminate=1;}
	...
	virtual void PreCalc(){;}	//wywolywane co kazdy krok przed obliczniami modeli
	virtual void PostCalc(){;}	//wywolywane co kazdy krok po obliczniach modeli
